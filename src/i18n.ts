...
export const COUNTRY_ISO_CODES: Record<string, string> = {
  ...
  "Guinea-Bissau": "GW", Guinea: "GN", "Ivory Coast": "CI", Kenya: "KE",
  ...
  Ukraine: "UA", UK: "GB", "Vatican City": "VA",
  // Special territories (overridden below — ISO codes kept for search)
  "Saint Helena": "SH", "Tristan da Cunha": "SH",
  // Oceania
