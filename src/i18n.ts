...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  ...
  de: {
    ...
    Monitoring: "Mögliche Exposition",
  ...
  fr: {
    ...
    Monitoring: "Exposition possible",
  ...
  es: {
    ...
    Monitoring: "Exposición potencial",
  ...
  pt: {
    ...
    Monitoring: "Exposição potencial",
  ...
  nl: {
    ...
    Monitoring: "Mogelijke blootstelling",
