...
function generateSummaryHtml(outbreaks) {
  ...
  const lines = [
    ...
    `        <p class="summary-definitions"><strong>Definitions:</strong> <em>Confirmed</em> — laboratory-confirmed case. <em>Probable/Suspected</em> — meets clinical criteria, laboratory result pending or inconclusive. <em>Under Monitoring</em> — no cases yet; individuals with possible contact under health surveillance. <em>Affected country</em> — at least one case or monitored individual officially reported.</p>`,
    `      </div>`,
    `    </section>`,
  ];
